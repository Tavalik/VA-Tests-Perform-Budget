...
Сценарий: 00.01 Установка значений констант, определение типа приложения
	...
	* Добавим валюты, если их нет
		...
		* EUR
			...
			И Я устанавливаю курс валюты с цифровым кодом "978" на дату "01.01.2021" в значение "90,7932" кратность "1"
			И Я устанавливаю курс валюты с цифровым кодом "978" на дату "01.02.2021" в значение "92,2963" кратность "1"
			И Я устанавливаю курс валюты с цифровым кодом "978" на дату "01.03.2021" в значение "90,3743" кратность "1"
		* USD
			И Я создаю валюту с цифровым кодом "840" символьным кодом "USD" и наименованием "Доллар США" если ее нет			
			И Я устанавливаю курс валюты с цифровым кодом "840" на дату "01.01.2021" в значение "73,8757" кратность "1"
			И Я устанавливаю курс валюты с цифровым кодом "840" на дату "01.02.2021" в значение "76,2527" кратность "1"
			И Я устанавливаю курс валюты с цифровым кодом "840" на дату "01.03.2021" в значение "74,4373" кратность "1"
...
Сценарий: 00.10 Создание Товарной категории
	...
	Если '$$ЭтоУХ$$' Тогда
		Если '$$ЭтоCPMWE$$' Тогда
			И Я создаю субконто УХ с именем "ВА - Номенклатура" и видом аналитики с кодом "ВА0ТовКате"
		Иначе
			И Я создаю товарную категорию с именем "ВА - Номенклатура" видом номенклатуры "ВА - Номенклатура"
...
Сценарий: 00.11 Создание Номенклатуры
	...
	Если '$$ЭтоУХ$$' Тогда	
		...
		И Я создаю номенклатуру с именем "1С:Управление холдингом 8" родителем "ВА - Номенклатура" видом номенклатуры "ВА - Номенклатура" артикулом "2900001916059" товарной категорией "Программные продукты"
...
Сценарий: 00.13 Создание Контрагентов и Договоров контрагентов
	...
	Если '$$ЭтоУХ$$' Тогда
		...
		И Я создаю договор для контрагента "ООО \"Ганимед\"" номер "Ганимед-002" дата "01.01.2021" валюта "RUB" организация "Меркурий ООО" вид "С покупателем" сумма "20000,00" условие оплаты "ВА - Соглашение с клиентом"
